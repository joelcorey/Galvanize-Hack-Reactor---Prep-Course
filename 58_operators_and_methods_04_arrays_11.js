...
Complete a function that takes in two parameters, an array and an index, 
removes the element from the index of the array, and returns the array. 
Your function should use the .splice() method to remove the element from 
the input array, at the given index, then return the array.
*/
